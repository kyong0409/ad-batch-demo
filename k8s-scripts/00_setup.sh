...
echo "  02: 배치 UI 이미지 빌드 (dscore-batch-ui)"
echo "  03: 배치 이미지 빌드 (batch-demo)"
echo "  04: Failing 배치 이미지 빌드 (failing-batch-demo)"
echo "  05: Enterprise 배치 이미지 빌드 (enterprise-batch)"
echo "  06: Enterprise Failing 배치 이미지 빌드 (enterprise-failing-batch)"
echo "  07: DAG 등록"
echo "  08: Port Forward (Ingress 접속)"
echo "  09: 이미지 정리 (cleanup)"
echo "========================================="
